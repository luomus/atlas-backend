...
describe('Collection SPECIES', () => {
  ...
  describe('Get species statistics for all atlases from API', () => {
    test('GET /api/v1/taxon/:id/atlas responds with JSON', (done) => {
      request(app)
          .get('/api/v1/taxon/:speciesId/atlas')
          .query({speciesId: 'MX.25836'})
          .expect(200, done)
          .expect('content-type', /application\/json/)
    })
  
    test('GET /api/v1/taxon/:id/atlas responds with correct data ', async () => {
      const res1 = await request(app).get('/api/v1/taxon/MX.25836/atlas')
      const res2 = await request(app).get('/api/v1/taxon/MX.25837/atlas')
  ...
  describe('Get species statistics for one atlas from API', () => {
    test('GET /api/v1/taxon/:id/atlas/:atlasId responds with JSON', (done) => {
      request(app)
    ...
    test('GET /api/v1/taxon/:id/atlas/:atlasId responds with correct data ', async () => {
...
describe('Collection AREA', () => {
  ...
  describe('Get statistics for area and atlas from API', () => {
...
describe('Collection AREA', () => {
  ...
  describe('Get atlas maps for species from API', () => {
    test('GET /api/v1/map/:speciesId/atlas/:atlasId responds with svg', (done) => {
      request(app)
          .get('/api/v1/map/MX.27850/atlas/3')
          .expect(200, done)
