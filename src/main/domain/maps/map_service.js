...
function MapService(atlasMap, gridArray) {
    ...
    function drawLegend(svgImage) {
        ...
        svgImage.addElement('rect', boxPropertyMap, 'legendBox')
                ...
                .addElement("rect", {id: "colourBox4", class: "colourBox", x: 1, y: 48, width: 1, height: 1, fill: getColorForBreedingCategory(4), stroke: "black", "stroke-width": 0.1 }, "legend")
                .addElement('text', { id: "colorTitle4", class: "colourTitle", x: 3, y: 49, "font-size": 2 }, 'legend')
                .setText("colorTitle4", "varma pesintä")
                .addElement("rect", {id: "colourBox3", class: "colourBox", x: 1, y: 52, width: 1, height: 1, fill: getColorForBreedingCategory(3), stroke: "black", "stroke-width": 0.1 }, "legend")
                .addElement('text', { id: "colorTitle3", class: "colourTitle", x: 3, y: 53, "font-size": 2 }, 'legend')
                .setText("colorTitle3", "todennäköinen pesintä")
                .addElement("rect", {id: "colourBox2", class: "colourBox", x: 1, y: 56, width: 1, height: 1, fill: getColorForBreedingCategory(2), stroke: "black", "stroke-width": 0.1 }, "legend")
